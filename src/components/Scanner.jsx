  ...
  return (
    <div className="metro-scan-view flex flex-col gap-6 max-w-7xl mx-auto w-full animate-in fade-in duration-300 pb-12">
      ...
      <div className="gov-card p-6 bg-white border border-slate-200 shadow-xs">
        ...
        {webcamActive && (
          <div className="mt-4 p-4 bg-slate-50 rounded-xl text-slate-800 flex flex-col gap-3 border border-slate-200 animate-in fade-in duration-200">
            <div className="w-full h-36 bg-slate-100 rounded-lg relative flex flex-col items-center justify-center text-center overflow-hidden border border-slate-300">
              <div className="scan-indicator-bar"></div>
              <Aperture size={28} className="text-slate-500 mb-1" />
              <span className="text-xs font-bold text-slate-800">Device Camera Viewfinder Active</span>
              <span className="text-[10px] text-slate-500 mt-0.5">Position package principal display panel within the frame</span>
            </div>
            <div className="flex gap-2">
              <button 
                onClick={handleCameraCapture}
                className="flex-1 bg-blue-700 hover:bg-blue-800 text-white font-bold text-xs py-2 rounded-lg flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
              >
                <Camera size={14} /> Capture Label Frame
              </button>
              <button 
                onClick={() => setWebcamActive(false)}
                className="border border-slate-300 text-slate-700 bg-white hover:bg-slate-50 text-xs px-3 py-2 rounded-lg transition-colors cursor-pointer"
              >
                Close Viewfinder
              </button>
            </div>
            ...
            <div className="scanner-viewport w-[300px] h-[380px] select-none relative">
              ...
              {uploadedImageSrc || selectedProduct?.customImageSrc ? (
                <div className="w-full h-full relative flex items-center justify-center bg-slate-100">
                  ...
                  />
                  <div className="absolute top-2 left-2 bg-blue-700 text-white text-[9px] font-bold px-2 py-0.5 rounded shadow">
                    Tesseract.js Target
                  </div>
                </div>
                ...
                >
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute inset-0 rounded border-2 border-red-600 bg-red-600/40 flex items-center justify-between px-2 shadow-lg">
                      ...
                      <span className="text-[7px] font-bold text-red-100 bg-red-950/90 px-1.5 py-0.5 rounded font-mono border border-red-800">
                        {tamperZone.severity}
                      </span>
                    </div>
                    {/* Crosshair markers */}
      ...
      <div className="gov-card p-4 bg-white border border-slate-200 shadow-xs">
        ...
        {showRawOcrDrawer && (
          <div className="mt-3 p-3 bg-slate-100 rounded-lg text-slate-800 font-mono text-xs max-h-48 overflow-y-auto whitespace-pre-wrap border border-slate-300 select-text">
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div className="flex flex-col gap-0.5">
              <div className="flex items-center gap-2">
                ...
                <span className="bg-white border border-slate-300 text-slate-800 text-[10px] font-mono font-extrabold px-2.5 py-0.5 rounded shadow-2xs">
